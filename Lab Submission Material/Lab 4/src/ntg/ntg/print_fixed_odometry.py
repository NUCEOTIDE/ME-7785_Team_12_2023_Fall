...
class print_transformed_odom(Node):
    def __init__(self):
        ...
        self.odom_sub = self.create_subscription(
            ...
            self.odom_callback,
            1)
        self.odom_pub = self.create_publisher(Float64MultiArray,'new_odom',10)
    ...
    def update_Odometry(self,Odom):
        ...
        new_odom = Float64MultiArray()
        new_odom.data = [float(self.globalPos.x),float(self.globalPos.y),float(self.globalAng)]
